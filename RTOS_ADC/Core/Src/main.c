...
/* Definitions for TaskADC_IN1 */
osThreadId_t TaskADC_IN1Handle;
const osThreadAttr_t TaskADC_IN1_attributes = {
  .name = "TaskADC_IN1",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for TaskADC_IN2 */
osThreadId_t TaskADC_IN2Handle;
const osThreadAttr_t TaskADC_IN2_attributes = {
  .name = "TaskADC_IN2",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
...
/**
  * @brief  Function implementing the TaskADC_IN1 thread.
...
/* USER CODE BEGIN Header_StartTaskADC_IN2 */
/**
* @brief Function implementing the TaskADC_IN2 thread.
* @param argument: Not used
* @retval None
*/
